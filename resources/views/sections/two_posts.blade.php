...
<section class="pt-21 pb-70 container px-5 mx-auto">
    ...
    <ul class="flex flex-col md:flex-row justify-between gap-y-55 gap-x-6 mt-12.5">
        @foreach($popular_posts as $post)
            <li class="relative group md:w-1/2">
