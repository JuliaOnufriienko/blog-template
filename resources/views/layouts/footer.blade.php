...
<footer x-data="" class=" bg-surface-lower text-text-bold/60 ">
    <div class="container mx-auto pt-20 xl:pt-24.75">
                ...
                <div class="">
                    ...
                    <ul class="flex flex-col gap-y-2.5">
                        ...
                        {{-- <template x-for="social in socials">
                            <li>
                                <a x-text="social.text" :title="social.title" :href="social.href" class="hover:text-text-bold animation"></a>
                            </li>
                        </template> --}}
                    </ul>
                </div>
